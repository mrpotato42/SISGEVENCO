...
public class CajaGui extends javax.swing.JDialog {
  ...
  TableRowSorter<TableModel> elqueOrdena;
    ...
    public CajaGui(java.awt.Frame parent, boolean modal) {// constructor de la GUI
        super(parent, modal);
        initComponents();
        ...
        EsconderColumnaCodigo();//llamado de metodo, que esconde la columna de la tabla que contiene codigo 
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtCodigoCaja, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtDescripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
      ...
      public void guardar(){// metodo que ejecuta algo en este caso instrucciones para insertar en la base de datos      
        Caja objCa=new Caja();//creamos el objeto a partir de la clase Barrio
        objCa.setDescripcion(txtDescripcion.getText());//seteamos la variable Nombre con lo que contenga el textfield llamado txtNombre
        objCa.setUbicacion((txtUbicacion.getText()));//seteamos la variable Comuna con lo que contenga el textfield llamado txtComuna
        
        if(objCtrlCa.guardar(objCa)){// como el metodo guardar nos arroja true o false lo metemos en esta condicion
            //si todo salio bien al momento de insertar nos arroja true y entra a las siguientes acciones
            JOptionPane.showMessageDialog(null,"La caja se registro!");//mensaje
           ...
           JOptionPane.showMessageDialog(null,"La caja NO Fue Registrado!");  
         }      
    }
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
            ...
            txtCodigoCaja.setText(tabla.getValueAt(filasele, 0).toString());
            txtDescripcion.setText(tabla.getValueAt(filasele, 1).toString());
            txtUbicacion.setText(tabla.getValueAt(filasele, 2).toString());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       ...
       public void editar(){// metodo editar que hace unas instrucciones para editar un registro
        Caja objCa;// referenciamos el objeto Barrio
        int codigoCaja=Integer.valueOf(txtCodigoCaja.getText());//almacenamos en esta variable lo que hay en el txtfield oculto que tiene el idBario
        String descripcion=txtDescripcion.getText();//almacenamos en esta variable lo que hay en el txtfield nombre
        String ubicacion=(txtUbicacion.getText());//almacenamos en esta variable lo que hay en el txtfield comuna
        
        objCa=new Caja(codigoCaja, ubicacion,descripcion);//instanciamos el objeto y le pasamos los valores de las variables que esta arriba
        
        if(objCtrlCa.modificar(objCa)){// validamos que se cumpla todo la modificacion recordemos que el metodo modificar arroja true o false
            JOptionPane.showMessageDialog(null,"La caja se Edito con Exito!");
            ...
            JOptionPane.showMessageDialog(null,"La caja No se Edito!");
        }   
    ...
    public void eliminar(){
        int codigoCaja=Integer.valueOf(txtCodigoCaja.getText());//almacenamos en esta variable lo que hay en el txtfield oculto que tiene el idBario
        int rspta=JOptionPane.showConfirmDialog(null, "¿Esta seguro de Eliminar esta Caja?",
        ...
        if(rspta==0){//comparamos la rspta, si se cumple hace lo siguiente
            if(objCtrlCa.eliminar(codigoCaja)){//recordemos que el metodo eliminar()arroja true o false si todo salio bien o mal
                JOptionPane.showMessageDialog(null,"Se elimino la Caja!");
    ...
    private void txtDescripcionKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescripcionKeyReleased
        ...
        String codigoCaja=txtCodigoCaja.getText();
        // "    miguel" arrojaria "miguel"
        //una vez limpia nuestro campo de espacios en blanco
        if(nombreSinEspacios.length()>0 && codigoCaja.length()==0){//comparamos que sea mayor a 0 es decir que tenga algo letras o numeros que exista algo
    ...
    public void traerDatosTable(){//como su nombre lo indica va a traer todos los datos en el jtable desde la base de datos
        ...
        ArrayList<Caja> listado=new ArrayList();//declaramos e instanciamos un array list de tipo Barrio llamado listado
        listado=objCtrlCa.listadoCaja();//almacenamos en listado lo que arroja el metodo listadoBarrio() que esta en la clase CtrlBarrio
       ...
       for(int index=0;index<listado.size();index++){//recorro el arrayList
                col[0]=listado.get(index).getCodigoCaja();
                col[1]=listado.get(index).getDescripcion();
                col[2]=listado.get(index).getUbicacion();                       
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CajaGui dialog = new CajaGui(new javax.swing.JFrame(), true);
