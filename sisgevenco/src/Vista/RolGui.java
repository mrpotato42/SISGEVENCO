 ...
 * @author JEFERSSON
 */
public class RolGui extends javax.swing.JDialog {
  ...
  TableRowSorter<TableModel> elqueOrdena;
    ...
    public RolGui(java.awt.Frame parent, boolean modal) {// constructor de la GUI
        super(parent, modal);
        initComponents();
        txtIdRol.setVisible(false);//esconde el campo del idBarrio ya que el usuario no tiene porque ver el id
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtIdRol, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
      ...
      public void guardar(){// metodo que ejecuta algo en este caso instrucciones para insertar en la base de datos      
        Rol objR=new Rol();//creamos el objeto a partir de la clase Barrio
        objR.setNombre(txtNombre.getText());//seteamos la variable Nombre con lo que contenga el textfield llamado txtNombre
        objR.setDescripcion((txDescripcion.getText()));//seteamos la variable Comuna con lo que contenga el textfield llamado txtComuna
        
        if(objCtrlR.guardar(objR)){// como el metodo guardar nos arroja true o false lo metemos en esta condicion
            //si todo salio bien al momento de insertar nos arroja true y entra a las siguientes acciones
            JOptionPane.showMessageDialog(null,"El rol se registro!");//mensaje
           ...
           JOptionPane.showMessageDialog(null,"El rol NO Fue Registrado!");  
         }      
    }
    ...
    private void tblRolMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRolMouseClicked
            ...
            filasele=tblRol.getSelectedRow();//nos arroja el numero da fila seleccionada que empieza de 0 a n filas
            ...
            */
            txtIdRol.setText(tblRol.getValueAt(filasele, 0).toString());
            txtNombre.setText(tblRol.getValueAt(filasele, 1).toString());
            txDescripcion.setText(tblRol.getValueAt(filasele, 2)+"");
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       ...
       public void editar(){// metodo editar que hace unas instrucciones para editar un registro
        Rol objR;// referenciamos el objeto Barrio
        int idrol=Integer.valueOf(txtIdRol.getText());//almacenamos en esta variable lo que hay en el txtfield oculto que tiene el idBario
        String nombre=txtNombre.getText();//almacenamos en esta variable lo que hay en el txtfield nombre
        String descripcion=(txDescripcion.getText());//almacenamos en esta variable lo que hay en el txtfield comuna
        
        objR=new Rol(idrol, nombre, descripcion);//instanciamos el objeto y le pasamos los valores de las variables que esta arriba
        
        if(objCtrlR.modificar(objR)){// validamos que se cumpla todo la modificacion recordemos que el metodo modificar arroja true o false
            JOptionPane.showMessageDialog(null,"El rol se Edito con Exito!");
            ...
            JOptionPane.showMessageDialog(null,"El rol No se Edito!");
        }   
    ...
    public void eliminar(){
        int idrol=Integer.valueOf(txtIdRol.getText());//almacenamos en esta variable lo que hay en el txtfield oculto que tiene el idBario
        int rspta=JOptionPane.showConfirmDialog(null, "¿Esta seguro de Eliminar este rol?",
        ...
        if(rspta==0){//comparamos la rspta, si se cumple hace lo siguiente
            if(objCtrlR.eliminar(idrol)){//recordemos que el metodo eliminar()arroja true o false si todo salio bien o mal
...
//        if(nombreSinEspacios.length()>0 && idRol.length()==0){//comparamos que sea mayor a 0 es decir que tenga algo letras o numeros que exista algo
...
//        }
    ...
    private void borrarJtable(){// este metodo limpia todo el jtable
        for (int i = tblRol.getRowCount() -1; i >= 0; i--){ 
                modelo.removeRow(i); 
        }      
    }
    
    public void traerDatosTable(){//como su nombre lo indica va a traer todos los datos en el jtable desde la base de datos
        modelo=(DefaultTableModel)tblRol.getModel();//nos arroja el modelo es decir el jtable
        elqueOrdena=new TableRowSorter<TableModel>(modelo);//ordena por columnas descendiente o ascendente lo que hay en el jtable
        tblRol.setRowSorter(elqueOrdena);//con esto se puede ordenar por col el jtable de manera asc o desc
                       
        ArrayList<Rol> listado=new ArrayList();//declaramos e instanciamos un array list de tipo Barrio llamado listado
        listado=objCtrlR.listadoRol();//almacenamos en listado lo que arroja el metodo listadoBarrio() que esta en la clase CtrlBarrio
       ...
       for(int index=0;index<listado.size();index++){//recorro el arrayList
                col[0]=listado.get(index).getIdRol();
    ...
    public void EsconderColumnaCodigo(){
        ...
        tblRol.getColumnModel().getColumn(0).setMaxWidth(0);
        tblRol.getColumnModel().getColumn(0).setMinWidth(0);
        tblRol.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
        tblRol.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RolGui dialog = new RolGui(new javax.swing.JFrame(), true);
