 ...
 * @author JEFERSSON
 */
public final class TipoIdentidadGui extends javax.swing.JDialog {
 
  //VARIABLES GLOBALES EN TODA ESTA CLASE  
  CtrlTipoIdentidad objCtrlT=new CtrlTipoIdentidad();
  DefaultTableModel modelo;//modelo de datos
  TableRowSorter<TableModel> elqueOrdena;
  
    public TipoIdentidadGui(java.awt.Frame parent, boolean modal) {// constructor de la GUI
        super(parent, modal);
        initComponents();
        txtIdTipoIdentidad.setVisible(false);//esconde el campo del idBarrio ya que el usuario no tiene porque ver el id
    ...
    private void initComponents() {
        ...
        txtIdTipoIdentidad.setEditable(false);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtIdTipoIdentidad, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtIdTipoIdentidad, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
      ...
      public void guardar(){// metodo que ejecuta algo en este caso instrucciones para insertar en la base de datos      
        TipoIdentidad objT=new TipoIdentidad();//creamos el objeto a partir de la clase Barrio
        objT.setNombreTipoIdentidad(txtNombre.getText());//seteamos la variable Nombre con lo que contenga el textfield llamado txtNombre
        //seteamos la variable Comuna con lo que contenga el textfield llamado txtComuna
        
        if(objCtrlT.guardar(objT)){// como el metodo guardar nos arroja true o false lo metemos en esta condicion
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
            ...
            filasele=tabla.getSelectedRow();//nos arroja el numero da fila seleccionada que empieza de 0 a n filas
            System.out.println("filasele="+filasele);//aqui se dan cuenta en consola que numero de fila es la clickeada
            
            txtIdTipoIdentidad.setText(tabla.getValueAt(filasele, 0).toString());
            txtNombre.setText(tabla.getValueAt(filasele, 1).toString());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       ...
       public void editar(){// metodo editar que hace unas instrucciones para editar un registro
        TipoIdentidad objT;// referenciamos el objeto Barrio
        int idtipoidentidad=Integer.valueOf(txtIdTipoIdentidad.getText());//almacenamos en esta variable lo que hay en el txtfield oculto que tiene el idBario
        String nombretipoidentidad=txtNombre.getText();//almacenamos en esta variable lo que hay en el txtfield nombre
        //almacenamos en esta variable lo que hay en el txtfield comuna
        
        objT=new TipoIdentidad(idtipoidentidad, nombretipoidentidad);//instanciamos el objeto y le pasamos los valores de las variables que esta arriba
        
        if(objCtrlT.modificar(objT)){// validamos que se cumpla todo la modificacion recordemos que el metodo modificar arroja true o false
            JOptionPane.showMessageDialog(null,"El tipo de identidad se Edito con Exito!");
            ...
            JOptionPane.showMessageDialog(null,"El tipo de identidad No se Edito!");
        }   
    ...
    public void eliminar(){
        int idtipoidentidad=Integer.valueOf(txtIdTipoIdentidad.getText());//almacenamos en esta variable lo que hay en el txtfield oculto que tiene el idBario
        int rspta=JOptionPane.showConfirmDialog(null, "¿Esta seguro de Eliminar este tipo de identificacion?",
        ...
        if(rspta==0){//comparamos la rspta, si se cumple hace lo siguiente
            if(objCtrlT.eliminar(idtipoidentidad)){//recordemos que el metodo eliminar()arroja true o false si todo salio bien o mal
                JOptionPane.showMessageDialog(null,"Se elimino el tipo de identificacion!");
    ...
    private void txtNombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyReleased
        ...
        String idTipoIdentidad=txtIdTipoIdentidad.getText();
        // "    miguel" arrojaria "miguel"
        //una vez limpia nuestro campo de espacios en blanco
        if(nombreSinEspacios.length()>0 && idTipoIdentidad.length()==0){//comparamos que sea mayor a 0 es decir que tenga algo letras o numeros que exista algo
    ...
    public void traerDatosTable(){//como su nombre lo indica va a traer todos los datos en el jtable desde la base de datos
        modelo=(DefaultTableModel)tabla.getModel();//nos arroja el modelo es decir el jtable
        elqueOrdena=new TableRowSorter<TableModel>(modelo);//ordena por columnas descendiente o ascendente lo que hay en el jtable
        tabla.setRowSorter(elqueOrdena);//con esto se puede ordenar por col el jtable de manera asc o desc
                       
        ArrayList<TipoIdentidad> listado=new ArrayList();//declaramos e instanciamos un array list de tipo Barrio llamado listado
        listado=objCtrlT.listadoTipoIdentidad();//almacenamos en listado lo que arroja el metodo listadoBarrio() que esta en la clase CtrlBarrio
       ...
       for(int index=0;index<listado.size();index++){//recorro el arrayList
                col[0]=listado.get(index).getIdTipoIdentidad();
                col[1]=listado.get(index).getNombreTipoIdentidad();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoIdentidadGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TipoIdentidadGui dialog = new TipoIdentidadGui(new javax.swing.JFrame(), true);
